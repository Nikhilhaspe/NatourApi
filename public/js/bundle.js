    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('/api/v1/users/signup', data);
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Account created successfully!, please wait redirecting...');
            window.setTimeout(function () {
              location.assign('/');
            }, 2000);
          }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm-signup').value;
